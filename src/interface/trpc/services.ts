...
export const holidayService = new HolidayService(prisma);
...
export const schedulingRules = new SchedulingRules(prisma);
...
export const studentQuotaService = new StudentQuotaService(prisma);
